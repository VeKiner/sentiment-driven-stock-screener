...
[![LangGraph](https://img.shields.io/badge/LangGraph-0.4.0-green.svg?logo=langchain)](https://langchain-ai.github.io/langgraph/)
...
**[English](#english) · [中文](#中文) · [快速开始](#-快速开始) · [报告示例](#-报告示例) · [项目结构](#-项目结构)**
...
> ⚠️ **免责声明**：本项目为技术研究工具，所有生成的策略报告仅供参考，不构成任何投资建议。投资有风险，决策请谨慎。
...
| 📄 **自动化报告** | Markdown → PDF 转换，上传 OSS 生成永久访问链接 |
...
| `strategy_pdf_upload` | Markdown → PDF 转换，上传 OSS，返回永久链接 |
...
> ⚠️ **风险提示**：以上报告为系统基于舆情数据生成的策略示例，不构成投资建议。请结合自身判断决策，风险自担。
...
│   ├── graphs/
│   │   ├── graph.py               # LangGraph 工作流图（18节点 DAG）
│   │   ├── node.py               # 所有节点函数实现
...
**[⬆ 返回顶部](#sentiment-driven-stock-screener)** · **[GitHub 仓库](https://github.com/VeKiner/sentiment-driven-stock-screener)**
